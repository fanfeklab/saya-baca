...
import { Play, RotateCcw, Gift, Sparkles } from "lucide-react";
  ...
  if (isWon) {
    return (
      <div className="flex flex-col p-8 gap-8 animate-in fade-in zoom-in duration-700 pb-32 min-h-[80vh] items-center justify-center text-center max-w-md mx-auto">
        <ConfettiBurst>
          <IllustrationHolder variant="success" size="xl" emoji="🏆" className="mx-auto mb-6 scale-125 border-4 border-black shadow-neo-lg" />
        </ConfettiBurst>

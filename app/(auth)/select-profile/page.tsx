...
import { Plus, Trash2, ArrowRight, Dice5, ShieldAlert } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  return (
    <div className="min-h-screen flex flex-col p-6 gap-8 animate-in fade-in slide-in-from-bottom-8 duration-700 max-w-2xl mx-auto justify-center">
      <div className="text-center space-y-2 mb-4">
        <NeoText variant="title" stroke className="text-4xl uppercase">PILIH PROFIL</NeoText>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
        ...
        {profiles.map((profile, index) => (
          <Card 
            ...
            className={cn(
              "relative border-2 border-black shadow-neo hover:shadow-neo-lg transition-all cursor-pointer group active:translate-y-1 active:translate-x-1 active:shadow-none overflow-hidden bg-card",
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-md border-4 border-black shadow-neo bg-card">
            <DialogHeader>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="relative group">
                  ...
                  <Button 
                    ...
                    className="absolute -bottom-2 -right-2 rounded-xl border-2 border-black shadow-neo-sm hover:shadow-neo active:shadow-none bg-background"
                  >
                    <Dice5 className="size-5" />
                  </Button>
                </div>
                <NeoText variant="body" className="text-[10px] uppercase font-black tracking-widest text-muted-foreground text-center">Sentuh Dadu untuk Random Avatar</NeoText>
              </div>

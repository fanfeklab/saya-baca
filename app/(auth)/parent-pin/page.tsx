...
export default function ParentPinPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 gap-8 bg-background relative overflow-hidden">
      {/* Decorative Ornaments (Blurry background elements) */}
      <div className="absolute top-10 left-10 size-32 bg-primary/10 rounded-full blur-3xl p-4" />
      <div className="absolute bottom-10 right-10 size-32 bg-accent/10 rounded-full blur-3xl p-4" />

      <div className="text-center space-y-4 max-w-sm z-10 p-2">

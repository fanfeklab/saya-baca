    ...
    <div className="min-h-screen relative z-10 flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="space-y-2">
          <h1 className="font-heading text-4xl font-black text-foreground uppercase">404</h1>
          <h2 className="font-heading text-xl font-black text-foreground uppercase">Halaman Tidak Ditemukan</h2>

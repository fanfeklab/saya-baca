...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-xl w-10 h-10 md:w-12 md:h-12 border-2 border-neoblack dark:border-foreground hover:bg-yellow-100 dark:hover:bg-slate-800 transition-colors"
      id="theme-toggle"
    >

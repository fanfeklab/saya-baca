...
const variantStyles = {
  primary: "bg-primary/20 bg-opacity-20 border-primary",
  secondary: "bg-secondary/20 bg-opacity-20 border-secondary",
  accent: "bg-accent/20 bg-opacity-20 border-accent",
  success: "bg-success/20 bg-opacity-20 border-success",

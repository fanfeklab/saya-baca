    ...
    <div className={cn("w-full space-y-4", className)}>
      <div className="flex items-center gap-4">
        <Button 
          ...
          size="icon-sm" 
          onClick={() => router.back()}
          className="rounded-xl shadow-neo-sm hover:shadow-neo active:shadow-none bg-background border-2 border-black"
        >
      ...
      <div className="space-y-1">
        <Progress value={progress} className="h-3 rounded-full border-2 border-border bg-background shadow-neo-sm" indicatorClassName="bg-primary" />
